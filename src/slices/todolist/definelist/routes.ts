...
import {DefineListCommand, handleDefineList} from './DefineListCommand';

export const api = (): WebApiSetup => (router: Router): void => {

    router.post('/api/definelist/:id', async (req: Request, res: Response) => {
        ...
        try {
            ...
            const result = await handleDefineList(id, command);
